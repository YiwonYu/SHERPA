# Codes borrowed from https://github.com/LeapLabTHU/DAT
...
class LocalAttention(nn.Module):
    ...
    def __init__(self, dim, heads, window_size, attn_drop, proj_drop, out_dim):
...
class DAttentionBaseline(nn.Module):
    ...
    def __init__(
        ...
        no_off, fixed_pe, ksize, log_cpb, out_hidden_size
    ):
        ...
        if self.q_h is not None and self.q_w is not None:
